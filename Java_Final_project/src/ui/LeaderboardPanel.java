...
public class LeaderboardPanel extends JPanel {
    ...
    // Container that holds all leaderboard entries
    ...
    public LeaderboardPanel(MainWindow window) {
        ...
        // Panel used to display player rankings
        ...
        // Exit button shown after the game ends
    ...
    // Display the final rankings sorted by score
    public void displayFinalStandings(Map<String, Integer> mapScores, String trackingSelfIdent) {
        SwingUtilities.invokeLater(() -> {
            ...
            List<Map.Entry<String, Integer>> standingsList =
                    new ArrayList<>(mapScores.entrySet());

            standingsList.sort((r1, r2) ->
            ...
            for (Map.Entry<String, Integer> rowNode : standingsList) {
                ...
                boolean matchingIdent =
                        rowNode.getKey().equals(trackingSelfIdent);
                ...
                JLabel positionLabel =
                        new JLabel("#" + operationalRank + "  ");

                positionLabel.setFont(
                        new Font("Monospaced", Font.BOLD, 20));

                // Highlight first place with a gold color
                ...
                JLabel totalValueLabel =
                        new JLabel(rowNode.getValue() + " pts");
